...
const Overview = () =>{
  return(
    ...
    <section className="section-break-1">
      <div className="row">
        <div className="col-md-6 col-lg-3">
          <OverviewCard title="Today's Sales" counts="Rs 5000" icon={FaRegMoneyBillAlt}/>
        </div>

        <div className="col-md-6 col-lg-3">
          <OverviewCard title="Weekly Sales" counts="Rs 50000" icon={FaFileInvoice}/>
        </div>

        <div className="col-md-6 col-lg-3">
          <OverviewCard title="Today's Expenses" counts="Rs 3000" icon={FaRegMoneyBillAlt}/>
        </div>

        <div className="col-md-6 col-lg-3">
          <OverviewCard title="Weekly Expenses" counts="Rs 40000" icon={FaFileInvoice}/>
        </div>
